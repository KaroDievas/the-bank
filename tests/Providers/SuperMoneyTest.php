...
class SuperMoneyTest extends KernelTestCase
{
    ...
    public function testDetails()
{
    ...
    $megaCash = new SuperMoney(json_encode($data), $this->serializer, $this->entityManager);

    $megaCash->initialise();

    $transaction = $megaCash->getTransaction();

    $this->assertNotEquals($transaction->getDetails(), substr($data['details'], 0, 20));
